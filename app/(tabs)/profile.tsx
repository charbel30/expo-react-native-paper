...
import { Surface, Card, Text, Button, List, Switch, Avatar, Divider } from 'react-native-paper'
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <Card style={styles.card}>
          <View style={styles.headerContainer}>
            <Avatar.Text size={80} label={userData.name.split(' ').map(n => n[0]).join('')} />
            <View style={styles.headerText}>
              <Text variant="headlineSmall">{userData.name}</Text>
              <Text variant="bodyMedium" style={styles.subText}>Patient ID: #12345</Text>
            </View>
          </View>
